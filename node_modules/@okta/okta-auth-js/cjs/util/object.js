...
function bind(fn, ctx) {
  var additionalArgs = (0, _slice.default)(Array.prototype).call(arguments, 2);
  return function () {
    var args = (0, _slice.default)(Array.prototype).call(arguments);
    args = (0, _concat.default)(additionalArgs).call(additionalArgs, args);
...
function extend() {
  ...
  var objArray = (0, _slice.default)([]).call(arguments, 1);
...
function clone(obj) {
  if (obj) {
    var str = (0, _stringify.default)(obj);
...
function omit(obj, ...props) {
  ...
  for (var p in obj) {
    if (Object.prototype.hasOwnProperty.call(obj, p) && (0, _indexOf.default)(props).call(props, p) == -1) {
      newobj[p] = obj[p];
    }
  }
